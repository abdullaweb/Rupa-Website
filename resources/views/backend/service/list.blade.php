                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->serviceDetail && $item->serviceDetail->service_image)
                                                            <div class="table_slider_list_image" style="background-image: url({{ asset($item->serviceDetail->service_image) }}); width: 80px;"></div>
                                                        @else
                                                            <span>No Image</span>
                                                        @endif
                                                    </td>
                                                    <td>{{ $item->title }}</td>
                                                    <td>{{ $item->serviceDetail->category->name ?? 'No Category' }}</td>
                                                    <td>
                                                        <div class="badges">
