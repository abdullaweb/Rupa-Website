...
@section('admin_title', 'Dashboard | Rupa Printing Press')
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-20"><a href="{{ route('admin.service-category.list') }}" class="custom_dashboard_title">Serivice Category</a></h5>
